...
from keyboardexpanse.key_combo import add_modifiers_aliases, parse_key_combo, KEYNAME_TO_CHAR
...
class KeyboardCapture(threading.Thread):
    ...
    def __init__(self):
        ...
        # (https://github.com/openstenoproject/keyboardexpanse/issues/484#issuecomment-214743466).
        #
