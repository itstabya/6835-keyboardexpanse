...
class Logger:
    ...
    def __init__(self):
        ...
        self._logger = logging.getLogger('keyboardexpanse')
        self._logger.addHandler(self._print_handler)
        self._logger.setLevel(INFO)
        self._stroke_filename = None
        self._stroke_logger = logging.getLogger('keyboardexpanse-strokes')
    ...
    def setup_platform_handler(self):
        ...
        try:
            if PLATFORM == 'linux':
                from keyboardexpanse.oslayer.log_dbus import DbusNotificationHandler
                handler_class = DbusNotificationHandler
            elif PLATFORM == 'mac':
                from keyboardexpanse.oslayer.log_osx import OSXNotificationHandler
                handler_class = OSXNotificationHandler
            elif PLATFORM == 'win':
                from keyboardexpanse.oslayer.log_plyer import PlyerNotificationHandler
